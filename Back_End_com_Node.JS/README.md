...
Nessa aula foi desenvolvido um back-end simples que recebe requisições HTTP através do http://localhost:3333/ e salva os dados em um array do próprio código.
...
* Nesse projeto também foi desenvolvido uma Middleware para validar o ID do projeto como UUID quando é feito alguma solicitação com parâmetro de ID.
